...
void xor_encrypt(char *input, char *output) {
	char key[] = "a";
...
void xor_decrypt(char *input, char *output) {
	xor_encrypt(input, output);
}

int StartServer(int port) {
	char msg1[] = "Server starting up.\n";
	char *msg1_enctypted = new char[strlen(msg1) + 1];
	xor_encrypt(msg1, msg1_enctypted);
	msg1_enctypted[strlen(msg1)] = '\0';
	printf("%s\n", msg1_enctypted);
	WSADATA Data;
