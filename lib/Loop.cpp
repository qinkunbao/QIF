...
namespace tana {
    ...
    namespace loop {
        ...
        Loop::Loop(std::vector<Inst>::const_iterator begin, std::vector<Inst>::const_iterator end) {
            loop_begin = begin;
            loop_end = end;
        ...
        bool Loop::checkLoopCurrent(std::vector<Inst>::const_iterator inst_current) {
            ++loop_current;
        ...
        std::list<Loop>
        InstructionMap::findPotentialLoops(std::vector<Inst>::const_iterator current,
                                           std::vector<Inst>::const_iterator instruction_end)
        {
            std::list<Loop> potential_loops;
        ...
        void
        InstructionMap::updateMap(std::vector<Inst>::const_iterator current)
        {
            auto current_inst_id = current->id;
            auto current_inst = current->instruction_id;
