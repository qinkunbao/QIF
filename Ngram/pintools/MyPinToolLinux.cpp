...
VOID static RTN_start(char *name, char *rtn_name) {
...
int main(int argc, char *argv[]) {
    ...
    string inst_file = function_name_str + "_inst.txt";
    string func_file = function_name_str + "_func.txt";

    fp = fopen(inst_file.c_str(), "w");
    rtn_fp = fopen(func_file.c_str(), "w");
    PIN_InitSymbols();
