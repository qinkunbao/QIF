\begin{table}[h]
\centering
\caption{Summary of all vulnerabilities in RSA implemented by openssl 1.1.1 with the amount of leak information}\label{tab:RSAopenssl}
\resizebox{\columnwidth}{!}{\begin{tabular}{clrrr}
\hline
\textbf{File} & \textbf{Line Num} & \textbf{Function} & \textbf{Leakedbits} & \textbf{Type} \\\hline
rsa\_ossl.c&399&rsa\_ossl\_private\_decrypt&0 &CF\\
bn\_lib.c&555&BN\_ucmp&Failed&\\
...
bn\_div.c&374&bn\_div\_fixed\_top&Failed&\\
