...
research~\cite{chistikov2017approximate,phan2015model} on Module Theories model counting (\#SMT).
Side channel leakage quantification cannot directly rely on \#SAT model counting. 
