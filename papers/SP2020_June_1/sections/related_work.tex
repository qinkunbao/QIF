...
exact model counters. Other approximate model counter includes \textit{SampleCount},
\textit{Mbound}, and \textit{MiniCout}. Compared to \textit{ApproxCount},
those model counters can give lower or upper bounds with guarantees.
However, none of them can scale to production software analysis while
our tool \tool\ can scale to real-world crypto libraries.
