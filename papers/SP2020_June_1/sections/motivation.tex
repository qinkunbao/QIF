...
For a real program, it is very hard to estimate the total information leakage.
We run the symbolic execution on the top of the execution traces. We use symbols
to represent each byte in the input buffer. Each temporary value is represent
