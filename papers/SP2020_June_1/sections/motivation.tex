...
Symbolic execution interprets each instructions and update the memory cells and registers with a 
formula that captured the sementics. Unfortunately, the number of machine instructions are huge
and the sementics of each instruction is complex. For example, the 

Existing binary analysis tools ~\cite{shoshitaishvili2016state, 10.1007/978-3-642-22110-1_37} will typically
translate machine instructions into intermediate languages.  
