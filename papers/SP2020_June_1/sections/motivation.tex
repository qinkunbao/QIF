...
and the sementics of each instruction is complex. For example, the Intel devloper manual~\cite{intelsys}
...
For an application with $n$ bits secret, there are total $2^n$ possible inputs. Of the
$2^n$ possible secrets, 
