...
Recent work~\cite{203878} adopts static and dynamic analysis
...
Static method, usually with the abstract interpretation can provide an upper bound, 
...
For example, CacheAudit~\cite{} reports the upper bound leakage of AES-128 exceeds the key size.
