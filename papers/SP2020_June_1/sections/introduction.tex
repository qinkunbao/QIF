...
tools. Our method is based on ... \fixme{Qinkun: explain in high level, but give a novelty sense on
how our method work, the method or theory, not workflow, not implementation.}
\Qinkun{Here is the intuition. Before the attack, the adversary has a big but finite input space.
...
actually leaked. On an extreme situation, if the size of the input space reduce to one, the
