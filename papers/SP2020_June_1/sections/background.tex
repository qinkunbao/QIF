...
The fundamental intuition is that every side-channels above happens when the program accesses different 
...
at the level of the cache line. For most CPU, one cache line holds 64 bytes of data. So
the low 6 bits the address is irrelevant in causing side-channels. 
