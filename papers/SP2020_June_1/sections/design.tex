...
With the~\ref{IndependentConstraint}, we can transfer counting a large constraint with high
dimensions into several small constraints and reduce the dimensions.
