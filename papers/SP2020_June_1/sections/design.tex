...
\Input{$F_{c_1c_2...c_n} = C_{g1} \land C_{g2} \land ... \land C_{gm}$}
\Output{The Maximum Independent Partition of $F$}
...
\begin{algorithm}
\SetAlgoLined
\KwIn{{The constraint $C_i$}}    
\KwOut{{The number of assignments that satisfy $C_i$ $|K_{Ci}|$}}
