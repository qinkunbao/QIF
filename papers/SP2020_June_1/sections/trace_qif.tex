...
then the $K^{o^{1}} = \{0x1b\}$. Therefore, the information leakage $L_{P(k)=o^{1}} = \log_2{256} - \log_2{1} = 8$
...
With the same definition~\ref{def}, we can also calculate the leaked information
from the sample code~\ref{background::side-channel}.
