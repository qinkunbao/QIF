...
\begin{enumerate}
      ...
      short constraints $c_{{addr}_i}$. The set containing the input variables of 
      $c_{{addr}_i}$ is the subset of the input variables of 
      $F(c_{\addr{1}},c_{\addr{2}},\ldots,c_{\addr{n}})$.
