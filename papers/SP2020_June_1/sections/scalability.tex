...
traditional general symbolic execution and be optimized to be as efficient as other
methods.

\subsubsection{Interpret Instructions Symbolically}


Unfortunately, the number of machine instructions 
...
\subsubsection{Complex Constriants}
