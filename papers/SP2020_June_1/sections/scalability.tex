...
intermediate languages (IR). Because the number of machine instructions is
...
is tedious to implement the manual rules for every instruction. On the contrary,
IR typically has fewer instructions compared to the original machine ISA\@.
However, the simplified designs of IR layer, which predigest the implementation
