...
Existing approach relies on SMT solvers (e.g, Z3) to find satisfying $k_1$ and $k_2$.
We argue that while it is a universal approach to solving constraints with SMT 
solvers, for constraints with above formats, using testing works better is more
