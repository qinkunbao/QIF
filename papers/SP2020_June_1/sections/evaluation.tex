...
in MbedTLS. Here we introduce and analyze two cases. %, as shown in Figure~\ref{fig:mbedtls_rsa_1} and \ref{fig:mbedtls_rsa_2}.
...
with high efficiency and constant running time. Eli Biham et al.~\cite{Biham:1997:FND:647932.757246} first
