...
\begin{table}[]
    ...
    \hline
    \multicolumn{1}{l|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}Number of\\Instructions\end{tabular}} & \multicolumn{2}{c|}{Time (s)}                           & \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}Number of\\Leakages (bits)\end{tabular}} \\ \cline{2-7} 
