...
\begin{table}[]
    ...
    \begin{tabular}{l|lll|lll}
                          & \multicolumn{3}{c|}{CacheD}       & \multicolumn{3}{c|}{CleversHans}  \\
                          & \# instructions & time & Leakages & \# instructions & time & Leakages \\ \hline
    AES openssl 0.9.7     &                 &      &          &                 &      &          \\
    AES openssl 1.0.2f    &                 &      &          &                 &      &          \\
    RSA openssl 0.9.7c    &                 &      &          &                 &      &          \\
    RSA openssl 1.0.2f    &                 &      &          &                 &      &          \\
    Total                 &                 &      &          &                 &      &          \\
    \# instruction / time & \multicolumn{3}{l|}{}             & \multicolumn{3}{l|}{}            
    \end{tabular}
    \end{table}
