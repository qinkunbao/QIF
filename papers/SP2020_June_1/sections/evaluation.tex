...
Considering Cache-Collision Timing Attack described in \ref{10.1007/11894063_16}, the probability of the leakage being observed is decreased by fewer byte-wide for the lookup table. Thus theoritycally, a one byte-wide lookup table (See Figure~\ref{}) will leaks less information than a four byte-wide one (See Figure~\ref{}).
