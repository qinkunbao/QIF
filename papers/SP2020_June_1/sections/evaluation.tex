...
of those vulnerabilities. \tool{} confirm our assumptions. The newer version of
OpneSSL obviously has less leaked sited compare to previous version.

For our evaluation, we test five versions of OpenSSL.
\begin{figure*}
    \centering
    \vspace*{-9pt}
    \hspace*{-8pt} 
