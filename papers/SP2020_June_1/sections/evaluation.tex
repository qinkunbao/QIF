...
\begin{table}[]
    ...
    AES 0.9.7             &             791              &     1704                   &             43.4s           & \multicolumn{1}{c|}{0.3s} & \multicolumn{1}{c|}{48}          &         75                            \\
    AES 1.0.2f            &           2410                &           1350            &            48.5s             & \multicolumn{1}{c|}{0.08s} & \multicolumn{1}{c|}{32}        &         88                        \\
    RSA 0.9.7             &             674,797        &     16,980,109               &       199.3s               & \multicolumn{1}{c|}{1681s} & \multicolumn{1}{c|}{2}           &         105                       \\
    RSA 1.0.2f            &          473,392           &      14,468,307              &          165.6s          & \multicolumn{1}{c|}{1692s} & \multicolumn{1}{c|}{2}             &         38                \\ \hline
    Total                 &            1,151,390       &      31,451,470              &             456.8s            & \multicolumn{1}{c|}{3373.4s} & \multicolumn{1}{c|}{84}     &         317             \\ \hline
    \begin{tabular}[c]{@{}c@{}}\# of Instruction \\ / Time\end{tabular} & \multicolumn{3}{c|}{2519 ($s^{-1}$)}                    & \multicolumn{3}{c}{9324 ($s^{-1}$)}                                                                  \\ \hline
    \end{tabular}
    }
    \caption{Comparison with CacheD}
    \end{table}

\subsection{Vulnerability Case Study}
