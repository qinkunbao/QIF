...
\begin{figure*}
    ...
    \subfloat[RSA OpenSSL 0.9.7]{
        \includegraphics[width=.2\linewidth]{./figures/result/RSA-openssl-0-9-7.pdf}
    \label{fig:1}
    }
    \subfloat[RSA OpenSSL 1.0.2f]{
        \includegraphics[width=.2\linewidth]{./figures/result/RSA-openssl-1-0-2f.pdf}
    \label{fig:1}
    }
    \subfloat[RSA OpenSSL 1.0.2k]{
        \includegraphics[width=.2\linewidth]{./figures/result/RSA-openssl-1-0-2k.pdf}
    \label{fig:1}]
    }
    \subfloat[RSA OpenSSL 1.1.0f]{
        \includegraphics[width=.2\linewidth]{./figures/result/RSA-openssl-1-1-0f.pdf}
    \label{fig:1}]
    }
    \subfloat[RSA OpenSSL 1.1.1]{
        \includegraphics[width=.2\linewidth]{./figures/result/RSA-openssl-1-1-1.pdf}
    \label{fig:1}]
    }
