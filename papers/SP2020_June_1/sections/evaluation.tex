...
\begin{table}[]
    ...
    \hline
    \multicolumn{1}{l|}{}                                               & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}\# of \\ Instructions\end{tabular}} & \multicolumn{2}{c|}{Time}                           & \multicolumn{2}{c}{\begin{tabular}[c]{@{}c@{}}\# of\\ Leakages\end{tabular}} \\ \cline{2-7} 
    \multicolumn{1}{l|}{}                                               & \multicolumn{1}{c|}{CacheD}                   & \multicolumn{1}{c|}{}                   & \multicolumn{1}{c|}{CacheD} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{CacheD}                & \multicolumn{1}{c}{}                \\ \hline
    ...
    \end{tabular}
    \caption{Comparison with CacheD. We }
    \end{table}
